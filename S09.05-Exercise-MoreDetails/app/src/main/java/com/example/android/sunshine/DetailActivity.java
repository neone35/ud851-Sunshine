...
//  COMPLETE (10) Remove the mWeatherDisplay TextView declaration
    ...
    private TextView tvWeatherHighTemp;
    private TextView tvWeatherLowTemp;
...
//      COMPLETE (13) Find each of the TextViews by ID
        tvWeatherDate = (TextView) findViewById(R.id.tv_display_date);
        tvWeatherDescription = (TextView) findViewById(R.id.tv_display_description);
        tvWeatherHighTemp = (TextView) findViewById(R.id.tv_display_high_temp);
        tvWeatherLowTemp = (TextView) findViewById(R.id.tv_display_low_temp);
        tvWeatherHumidity = (TextView) findViewById(R.id.tv_display_humidity);
        tvWeatherWind = (TextView) findViewById(R.id.tv_display_wind);
        tvWeatherPressure = (TextView) findViewById(R.id.tv_display_pressure);

//      COMPLETE (14) Remove the code that checks for extra text
//        Intent intentThatStartedThisActivity = getIntent();
//        if (intentThatStartedThisActivity != null) {
//            if (intentThatStartedThisActivity.hasExtra(Intent.URI_INTENT_SCHEME)) {
...
//          COMPLETED (23) If the loader requested is our detail loader, return the appropriate CursorLoader
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        tvWeatherDate.setText(dateText);
        ...
        tvWeatherHighTemp.setText(highString);

        double lowInCelsius = data.getDouble(INDEX_WEATHER_MIN_TEMP);
        String lowString = SunshineWeatherUtils.formatTemperature(this, lowInCelsius);
        tvWeatherLowTemp.setText(lowString);

        float humidity = data.getFloat(INDEX_WEATHER_HUMIDITY);
        String humidityString = getString(R.string.format_humidity, humidity);
        tvWeatherHumidity.setText(humidityString);

        float windSpeed = data.getFloat(INDEX_WEATHER_WIND_SPEED);
        float windDirection = data.getFloat(INDEX_WEATHER_DEGREES);
        String windString = SunshineWeatherUtils.getFormattedWind(this, windSpeed, windDirection);
        tvWeatherWind.setText(windString);

        float pressure = data.getFloat(INDEX_WEATHER_PRESSURE);
        String pressureString = getString(R.string.format_pressure, pressure);
        tvWeatherPressure.setText(pressureString);
    }
