...
public class MainActivity extends AppCompatActivity {
    ...
    public class fetchWeatherTask extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL... urls) {
            ...
            String weatherQueryResult = null;
            try {
                weatherQueryResult = NetworkUtils.getResponseFromHttpUrl(searchUrl);
            } catch (IOException e) {
                e.printStackTrace();
            }
        ...
        @Override
        protected void onPostExecute(String weatherQueryResult) {
//            progressBarSearch.setVisibility(View.INVISIBLE);
            if (weatherQueryResult != null && !weatherQueryResult.equals("")) {
                mWeatherTextView.setText(weatherQueryResult);
            }
        }
    }
